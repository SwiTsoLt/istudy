...
import { DataChannelLabelEnum, DataChannelMessageDataType, DataChannelMessageType, webRtcActionsEnum } from "./webrtc.interface";
...
export const addIceCandidate = createAction(webRtcActionsEnum.addIceCandidate, props<{ candidate: RTCIceCandidate | undefined }>());
...
export const sendMessage = createAction(webRtcActionsEnum.sendMessage, props<{ label: DataChannelLabelEnum, dataType: DataChannelMessageType, data: DataChannelMessageDataType }>());